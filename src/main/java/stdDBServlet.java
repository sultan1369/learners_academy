...
@WebServlet("/Student")
public class stdDBServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
            ...
            String sql = "UPDATE student SET First_Name=?, Middle_Name=?, Last_Name=?, Date_Of_Birth=?, Gender=?, Email=?, Institute=?, Course=? WHERE id=?"; // Assuming you have an 'id' column in your 'students' table
            ...
            preparedStatement.setInt(9, 123); // Replace '123' with the actual student id
